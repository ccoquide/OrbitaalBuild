...
for file in os.listdir(f"{PATH}/TEMPORAL/bis_2_network_2009_2021_name/"):
    os.remove(f"{PATH}/TEMPORAL/bis_2_network_2009_2021_name/{file}")
os.removedirs(f"{PATH}/TEMPORAL/bis_2_network_2009_2021_name")

...
from pyspark.sql.functions import from_unixtime,year, month, dayofmonth, hour, minute, second, to_utc_timestamp, unix_timestamp, date_format
...
for file in os.listdir(f"{PATH}/TEMPORAL/network_2009_2021.parquet"):
    os.remove(f"{PATH}/TEMPORAL/network_2009_2021.parquet/{file}")
